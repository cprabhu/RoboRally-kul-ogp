...
public class Robot implements IRobot {
    ...
    public void moveNextTo(IRobot robot2) throws IllegalArgumentException {
        ...
        long minManhattanDistance = getManhattanDistance(getX(), getY(),
        ...
        double minPairEnergy = getEnergyRequiredToReach(firstPair[0][0],
                firstPair[0][1])
        ...
        double minExpendedEnergyDifference = Math.abs(getEnergyRequiredToReach(
                firstPair[0][0], firstPair[0][1])
                - robot2.getEnergyRequiredToReach(firstPair[1][0],
                        firstPair[1][1]));
    ...
    @Basic
    @Immutable
    public static final double getMaxEnergy() {
        return MAXENERGY;
    }
