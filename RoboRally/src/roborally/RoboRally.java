...
public class RoboRally<Board, Robot, Wall, Battery> extends JFrame {
    ...
    private void processCommand(String command) {
        ...
        if (words[0].equals("addrobot") && 4 <= words.length
        ...
        } else if (words[0].equals("addbattery") && 4 <= words.length
                && words.length <= 6) {
            String name = words[1];
            ...
            try {
                ...
                out.println("position expected but found " + words[1] + " "
                        + words[2]);
                return;
            }
            ...
            double required = facade.getMinimalCostToReach(robots.get(name), x,
                    y);
            if (required == -1) {
    ...
    public static void main(String[] args) {
        ...
        /* <begin> */
        RoboRally<roborally.model.Board, roborally.model.Robot, roborally.model.Wall, roborally.model.Battery> roboRally = new RoboRally<roborally.model.Board, roborally.model.Robot, roborally.model.Wall, roborally.model.Battery>(
                new roborally.model.Facade());
        /* <end> */
